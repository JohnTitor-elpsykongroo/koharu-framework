...
public class PropertyResolverTest {
    ...
    public void propertyValue() {
        ...
        props.setProperty("app.title", "Koharu Framework");
        ...
        assertEquals("Koharu Framework", pr.getProperty("app.title"));
        ...
        assertEquals("John Titor", pr.getProperty("app.author", "John Titor"));
